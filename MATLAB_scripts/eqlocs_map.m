...
latm = (53.7871);
lonm = (-2.951620);
l2=textm(latm,lonm,placem,'fontsize',22,'color','r');
...
txt3={'BGS Epicentres: x'};
l6=textm(53.75, lonr2,txt3,'fontsize',16,'color','k');
txt4={'Study Epicentres: x'};
l7=textm(53.74,lonr2,txt4,'fontsize',16,'color','b');

txt5={'NON-BGS Epicentres: x'};
l8=textm(53.73,lonr2,txt5,'fontsize',16,'color','c');
...
for i=1:16
    ...
    label(i)=textm(bgs_locs_lat(i), bgs_locs_lon(i),labeltxt2,'fontsize',15,'color','k');
    labelz(i)=textm(my_locs_lat(i),my_locs_lon(i),labeltxt2,'fontsize',15,'color','b');
end

for i=1:3
    labelzz(i)=textm(onlymy_locs_lat(i),onlymy_locs_lon(i),labeltxt2,'fontsize',15,'color','c');
end

scaleruler on
northarrow('latitude', 53.84, 'longitude', -3.25,'scaleratio', 0.11);
t1=title(h1,'Earthquake Locations Comparison','fontsize',18); %adding a title to figure


h2 = axes('pos',[.6 .1 .3 .3]);
worldmap([53.75 53.8],[-3.0 -2.9]);
...
latm = (53.7871);
lonm = (-2.951620);
l2=textm(latm,lonm,placem,'fontsize',18,'color','r');
...
for i=1:16
    ...
    label(i)=textm(bgs_locs_lat(i), bgs_locs_lon(i),labeltxt2,'fontsize',14,'color','k');
    labelz(i)=textm(my_locs_lat(i),my_locs_lon(i),labeltxt2,'fontsize',14,'color','b');
end

for i=1:3
    labelzz(i)=textm(onlymy_locs_lat(i),onlymy_locs_lon(i),labeltxt2,'fontsize',14,'color','c');
end
