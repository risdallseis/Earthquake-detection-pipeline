...
t1 = obspy.UTCDateTime(sys.argv[1])#("2018-10-29-T11:30:30")
st = read(sys.argv[2], starttime=t1, endtime=t1+60*20)
...
plt.figure()
plt.plot(fre12,datafft2,'k')
plt.tick_params(labelsize=20)
plt.yscale("log")
plt.xscale("log")

plt.ylabel('Amplitude (counts)',fontsize=18)

plt.xlabel('Frequency (Hz)',fontsize=18)
plt.title('One-Sided Fourier Amplitude Spectrum',fontsize=20)
#plt.plot(data)
zchan=st.copy()
#zchan2=st2.copy()
#zchan3=st3.copy()
