# -*- coding: utf-8 -*-
"""
Created on Sun Apr 14 16:45:04 2019
...
plt.figure()
plt.suptitle('Seismometer Correction',fontsize=16)
plt.subplot(411)
#plt.title((tr[0].stats.station,tr[0].stats.channel,tr[0].stats.starttime))
plt.plot(t,tr1[0].data,'k-')
plt.tick_params(labelsize=12)
plt.xlabel('Time (s)',fontsize=13)
plt.ylabel('Counts (-)',fontsize=13)
plt.legend(['Raw data'],fontsize=13)
pre_filt = (0.3, 0.5, 45.0, 50.0)#pre FILTER TO  PREVENT NOISE AMPLIFICATION DURING DECONVOLUTION
...
plt.legend(['Ground Motion'],fontsize=13)
...
plt.xlabel('Time (s)',fontsize=13)
plt.tick_params(labelsize=12)
plt.ylabel('Displacement (mm)',fontsize=13)
plt.legend(['Ground Data'],fontsize=13)
...
plt.tick_params(labelsize=12)
plt.ylabel('Displacement (mm)',fontsize=13)
plt.legend(['Wood-Anderson response removed'],fontsize=13)
